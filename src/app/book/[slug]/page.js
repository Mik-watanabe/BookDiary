    ...
    return <>
        {isLoading ? (
          ...
          <section>
            <div className='grid grid-cols-3 gap-14'>
              <div className='w-full col-span-1'>
                ...
                <button className='border w-full mt-4 p-1 rounded-lg border-black hover:bg-black/40 hover:text-white hover:border-opacity-20'>Read Sample</button>
              </div>
              <div className='col-span-2'>
                ...
                <div className='mt-4 text-xl'>
                  <div>
                    ...
                    <span className='pl-4'>{bookInfo?.authors.map((el) => el)}</span>
                  </div>
                  <div className='mt-2'>
          ...
          <section className='border-t border-black mt-12 pt-8'>
            ...
            <div className="mt-2" dangerouslySetInnerHTML={{ __html: bookInfo?.description.replace(/<b>/g, '') }} />
          </section>
          {/* // over view
          // similar books
